<template>
	<view class="login-container">
		<!-- 	 <view class="inaver _30f2b4d" :style="'background:'+style_obj.titleBackgroundColor+';color:'+style_obj.titleTextColor">
		    ...
		    <view class="center _30f2b4d" style="text-align: center;margin-top: 20rpx;font-size: 34rpx;margin-right: 100rpx;">
