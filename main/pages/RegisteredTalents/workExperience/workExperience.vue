<template>
	<view style="padding: 24rpx;padding-bottom: 180rpx;">
		<u-form :model="form" ref="uForm">
			...
			<u-form-item prop="company_name" label-width="135" label-align="right" :border-bottom="false"
				label="公司名称"><u-input v-model="form.company_name" placeholder="请输入公司名称" /></u-form-item>
			...
			<u-form-item prop="work_name" label-width="135" label-align="right" :border-bottom="false"
				label="职位名称"><u-input v-model="form.work_name" placeholder="请输入职位名称" /></u-form-item>
			<u-form-item prop="work_note" label-width="135" label-align="right" :border-bottom="false" label="工作内容">
				<textarea name="" id="" cols="30" rows="10" v-model="form.work_note"
					placeholder-style="color: rgb(192, 196, 204);" placeholder="请输入工作内容"></textarea>
			</u-form-item>
		</u-form>
...
<script>
	...
	export default {
		...
		onLoad(e) {
			console.log(e);
			if(uni.getStorageSync('work').length && e.index){
				this.form = uni.getStorageSync('work')[e.index]
