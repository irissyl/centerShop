	...
	<scroll-view scroll-y="true" class="product-detail scroll-Y"
		...
		<view class="product-evaluate bg-white">
			<view class="evaluat-title flex-c">
				评价({{detail.comment_data_count || 0}})
		...
		<!-- 店铺信息 -->
		<view class="shop-group bg-white" v-if="detail.supply_id > 0 && supply_open > 0 && supply_show > 0">
		...
		<!-- 商品详情 -->
		<view class="product-introduce bg-white">
			<view class="introduce-title">
				商品详情
			</view>
			<!-- <view v-if="detail.content" class="introduce-content" v-html="detail.content"></view> -->
			<!-- <rich-text v-if="detail.content" class="content-box" :nodes="detail.content" @itemclick="getImagesUrl"></rich-text> -->
		...
		<view class="product-tabbar flex-c">
			<view class="tabbar-handle flex-c">
				<view class="handle-item">
					<view class="icon">
						<image src="@/static/product/icon1.png"></image>
					</view>
				...
				<view class="handle-item">
					<view class="icon">
						<image src="@/static/product/icon2.png"></image>
					</view>
					<view class="handle-label">
						收藏
					</view>
				...
				<view class="handle-item">
					<view class="icon">
						<image src="@/static/product/icon3.png"></image>
					</view>
					<view class="handle-label">
						客服
					</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			/*选规格*/
			openPopup(e) {
				if (this.supply && this.supply.is_forbidden_buy == 1) {
					this.tips_data = {
						img: this.supply.wxqrcode,
					};
					this.is_tips = true;
					return;
				}
