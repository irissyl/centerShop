<template>
	<view class="diy-banner-box">
		...
		<!-- 财富机遇 -->
		<Label :item="item2"  :name="itemData.params.name" v-if="itemData.data.length > 0"></Label>
		<Project :projectData="itemData.data"></Project>
	</view>
</template>
...
<script>
	...
	export default {
		...
		mounted() {
			var self = this;
			setTimeout(function() {
				self.item2.color = self.getMainTextColor()
